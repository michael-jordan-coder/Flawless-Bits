...
// utility classes. Several large soft radial color blobs orbit on smooth paths
// under a soft blur so the colors blend into a living mesh. Single rAF loop,
// dpr-scaled canvas, ResizeObserver. Honors prefers-reduced-motion.

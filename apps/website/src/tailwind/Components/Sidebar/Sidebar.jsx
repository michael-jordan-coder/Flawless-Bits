...
export default function Sidebar({
  ...
  const [width, setWidth] = useState(() => clamp(defaultWidth, minWidth, maxWidth));
  ...
  return (
    ...
    >
      ...
      {!collapsed && (
        <div
          className={twMerge(
            "group absolute -right-1 top-0 h-full w-2 cursor-ew-resize touch-none bg-transparent before:absolute before:left-[3px] before:top-0 before:h-full before:w-px before:bg-transparent before:transition-colors before:duration-150 before:content-[''] hover:before:bg-[#a855f7] motion-reduce:before:transition-none",

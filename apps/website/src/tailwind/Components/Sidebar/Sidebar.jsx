...
export default function Sidebar({
  ...
  const rootStyle = {
    ...
    '--ui-sidebar-border': `color-mix(in oklch, ${accentColor} 14%, #1a1a1a)`,
    '--ui-sidebar-hover': `color-mix(in oklch, ${accentColor} 12%, ${surfaceColor})`,
    '--ui-sidebar-active': `color-mix(in oklch, ${accentColor} 22%, ${surfaceColor})`
  };
